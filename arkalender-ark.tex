\documentclass[ngerman,emoji]{tikz-kalender}
\usepackage[utf8]{inputenc}
\usepackage[T1]{fontenc}
\usepackage{ark-krause}
\usepackage{arkalender}

\setup{
  paper=a4,
  year=2025,
  title={\parbox{15cm}{\center Arkalender\\\normalsize Erstellt mit \emoji{heart} und \LaTeX\ am \today}},
  showweeknumbers,
  titleColor=ARKrot,
  monthBGcolor=ARKrot,
  saturdayColor=ARKrot!20,
  sundayColor=ARKrot,
  eventColor=ARKgrau!20,
  periodColor=ARKgrau!20,
  events={%
    akobe,
    akobe2,
    geburtsdaten-akobe,
